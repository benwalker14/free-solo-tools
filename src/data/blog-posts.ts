...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title:
      "CodeBeautify Alternative: 114 Tools That Never See Your Data",
    description:
      "CodeBeautify stores your data on their servers. DevBolt offers 114 free developer tools that run 100% client-side — your JSON, JWTs, code, and credentials never leave your browser.",
    publishedAt: "2026-03-19",
    readTime: "11 min read",
