  ...
  return (
    <>
      <p className="text-lg text-gray-600 dark:text-gray-400">
        ...
        DevBolt offers 118 developer tools that run entirely in your browser.
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            <tr>
              ...
              <td className="px-4 py-2.5 text-emerald-600 dark:text-emerald-400 font-medium">118 tools</td>
...
❌ POST requests to an API = server-side (your data was sent somewhere)`}</CodeBlock>
      ...
      <h2 className="mt-12 mb-4 text-2xl font-semibold text-gray-900 dark:text-white">
        All 118 Tools &mdash; Organized by Category
      </h2>
      ...
      <p className="text-gray-600 dark:text-gray-400">
        ...
        the only one with 118+ tools that are all client-side:
      </p>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            <tr>
              ...
              <td className="px-4 py-2.5 text-gray-900 dark:text-white font-medium">118</td>
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 text-gray-600 dark:text-gray-400">
        ...
        <li>
          <ToolLink href="/">Browse all 118 tools</ToolLink>
      ...
      <InfoBox>
        ...
        from any page to instantly search all 118 tools. Use arrow keys to
      ...
      <div className="mt-6 space-y-6">
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Yes. All 118 tools are free to use with no signup, no account,
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            DevBolt has 118 tools vs devformat&apos;s ~52. DevBolt also
