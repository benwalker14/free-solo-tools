...
export const metadata: Metadata = {
  title: "Free Developer Tools Online — 99+ Browser-Based Utilities",
  description:
    "99+ free online developer tools that run entirely in your browser. JSON formatter, Base64 encoder, hash generator, UUID generator, regex tester, and more. No signup, no tracking, 100% client-side.",
  keywords: [
  ...
  openGraph: {
    title: "Free Developer Tools Online — 99+ Browser-Based Utilities",
    description:
      "99+ free online developer tools. No signup, no tracking. JSON formatter, Base64, hash generator, UUID, regex tester, and more. 100% client-side.",
  ...
  twitter: {
    ...
    title: "Free Developer Tools Online — 99+ Browser-Based Utilities",
    description:
      "99+ free online developer tools. No signup, no tracking. 100% client-side.",
  },
  alternates: {
...
const webpageJsonLd = {
  ...
  description:
    "99+ free online developer tools that run entirely in your browser. No signup, no tracking, 100% client-side.",
  url: `${BASE_URL}/free-tools`,
  isPartOf: {
    "@type": "WebSite",
    name: "DevBolt",
